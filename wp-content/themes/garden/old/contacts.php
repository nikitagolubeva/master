        ...
        <main class="contacts-page">
            ...
            <section class="phones-block">
                <div class="phone-item">
                    <a href="tel:+79218863366" class="phone-item__phone">+7 (921) 886-33-66</a>
                    <span class="phone-item__name">Единый номер</span>
                </div>
                <div class="phone-item">
                    <a href="tel:+79697167133" class="phone-item__phone">+7 (969) 716-71-33</a>
                    <span class="phone-item__name">Отдел благоустройства, проектирование, оптовые закупки</span>
                </div>
            </section>
            <section class="addresses-block">
                <div class="address-item">
                    ...
                    <h2 class="address-item__header">ВСЕВОЛОЖСКИЙ РАЙОН</h2>
                    <div class="address-item__info">
                        <div class="address-item__line address-item__address-line">
                            ...
                            <p class="address-item__text">г. Санкт-Петербург, Всеволожский район, 11 км Новоприозерского шоссе</p>
                        </div>
                        <div class="address-item__line">
                            ...
                            <p class="address-item__text">9:00-19:00, без&nbsp;выходных</p>
                        </div>
                        <div class="address-item__line">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="address-item__contacts">
                                <p class="address-item__text">
                                    <a href="tel:">+7 (921) 886-33-66</a><span> — единый номер</span>
                                </p>
                                <p class="address-item__text">
                                    <a href="tel:+79215555884">+7 (921) 555-58-84</a><span> — менеджер площадки</span>
                                </p>
                            </div>
                        </div>
                        <div class="address-item__line">
                            ...
                            <p class="address-item__text">
                                <a href="mailto:nikitagolubeva@mail.ru">nikitagolubeva@mail.ru</a>
                            </p>
                        </div>
                    </div>
                    <div class="address-item__map">
                        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A44e0e5291af295d7f8866540c00012de41104a86176044ea512200931af7a1e7&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="address-item">
                    <button class="address-item__btn js-show-contacts">
                    ...
                    <h2 class="address-item__header">СЕСТРОРЕЦК</h2>
                    <div class="address-item__info">
                        <div class="address-item__line">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M28.2483 25.868L19.9987 34.1666L11.7491 25.868C7.193 21.2848 7.193 13.8539 11.7491 9.27072C16.3052 4.68751 23.6922 4.68751 28.2483 9.27072C32.8044 13.8539 32.8044 21.2848 28.2483 25.868ZM19.9987 23.3333C23.2204 23.3333 25.832 20.7216 25.832 17.5C25.832 14.2783 23.2204 11.6666 19.9987 11.6666C16.777 11.6666 14.1654 14.2783 14.1654 17.5C14.1654 20.7216 16.777 23.3333 19.9987 23.3333Z" fill="#3E683A" />
                            ...
                            <p class="address-item__text">г. Сестрорецк, Приморское шоссе 311</p>
                        </div>
                        <div class="address-item__line">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M20 32C26.6274 32 32 26.6274 32 20C32 13.3726 26.6274 8 20 8C13.3726 8 8 13.3726 8 20C8 26.6274 13.3726 32 20 32ZM21 12.2857C21 11.7334 20.5523 11.2857 20 11.2857C19.4477 11.2857 19 11.7334 19 12.2857V20C19 20.5523 19.4477 21 20 21H27.7143C28.2666 21 28.7143 20.5523 28.7143 20C28.7143 19.4477 28.2666 19 27.7143 19H21V12.2857Z" fill="#3E683A" />
                        ...
                        <div class="address-item__line">
                            ...
                            <div class="address-item__contacts">
                                ...
                                <p class="address-item__text">
                                    <a href="tel:+79218099959">+7 (921) 809-99-59</a><span> — менеджер площадки</span>
                                </p>
                            </div>
                        </div>
                        <div class="address-item__line">
                    ...
                    <div class="address-item__map">
                        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ae9cbb7df068ddc7c69958c450ef42e195978fd9d5ff32d42b33b8fa9cf72b4be&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
                    </div>
                </div>
            </section>
        </main>
