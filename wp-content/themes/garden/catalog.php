 ...
 <div class="wrapper">
        ...
        <main class="catalog">
            ...
            <section class="catalog__container">
                <div class="catalog__mobile-search">
                    ...
                    <div class="select-container sort-select-container js-mobile-sort-select">
                        <select class="select sort-select" id="sort-select" name="sort">
                            ...
                            <option value="update">По новизне</option>
                ...
                <div class="catalog-categories" data-default="<?= array_key_exists('category', $_GET) ? $_GET['category'] : '' ?>">
                    <ul>
                    ...
                    $product_categories = get_terms($args);
                     ...
                     foreach ($product_categories as $product_category) {
                         ...
                         <li class="catalog-categories__item" data-category="<?= $product_category->term_id ?>"><?= $product_category->name ?></li>
