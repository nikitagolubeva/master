...
require_once "template-parts/data-changer.php";
global $current_user;
wp_get_current_user();
?>
        ...
        <main class="account">
            ...
            <div class="account__container">
                <!-- <ul class="account__nav" data-select="data">
                    <a href="/account" class="account__nav__item active" data-select="data">
                    ...
                    <section class="data-section">
                        <div class="data-section__container">
                            <div class="data-section-item">
                                ...
                                <p class="data-section-item__value js-account-name"><?php echo $current_user->display_name; ?></p>
                            </div>
                            <div class="data-section-item">
                                <p class="data-section-item__label">Телефон</p>
                                <p class="data-section-item__value js-account-phone"><?php echo get_user_meta($current_user->ID, "phone", true); ?></p>
                            </div>
                            <div class="data-section-item">
                                <p class="data-section-item__label">Почта</p>
                                <p class="data-section-item__value js-account-email"><?php echo $current_user->user_email; ?></p>
                            </div>
                        </div>
