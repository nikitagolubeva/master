        ...
        <main class="account">
            ...
            <div class="account__container">
                <ul class="account__nav" data-select="data">
                    <a href="#" class="account__nav__item" data-select="data">
                    ...
                    <a href="#" class="account__nav__item active" data-select="orders">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <section class="order-section">
                        ...
                        <div class="order-section__container">
                            <div class="account-order-item">
                                ...
                                <p class="account-order-item__date">23.04.23</p>
                                <div class="account-order-item__statuses">
                                    <p>ожидается доставка</p>
                                    <p>оплачено по карте</p>
                                </div>
                                <div class="account-order-item__goods">
                                    <div class="account-order-product">
                                        <div class="account-order-product__container">
                                            <img class="account-order-product__img" src="resourses/product.jpg" alt="изображение продукта">
                                            <div class="account-order-product__info">
                                                <div class="account-order-product__header">
                                                    <p class="account-order-product__name">Медуница гибридная Опал С3 ица гибридпа ица гибридная Опа</p>
                                                    <p class="account-order-product__amount">Количество<span>1</span></p>
                                                    <p class="account-order-product__amount tablet">Кол-во<span>1</span></p>
                                                </div>
                                                <p class="account-order-product__price desc">550 ₽/шт</p>
                                                <p class="account-order-product__price mobile">550 ₽/шт x 1 = 1100 ₽</p>
                                                <div class="account-order-product__extra-info">
                                                    <p>Артикул: <span>medunica-opal</span></p>
                                                    <p>Сорт: <span>medunica</span></p>
                                                </div>
                                                ...
                                                <p class="account-order-product__desc">
                                                    Медуница относится к группе низкорослых цветов. Высота растения не превышает 30 сантиметров. Ствол плотный, обильно покрыт мелкими ворсинками. Корневая система хорошо развита. Лиственные пластины двух видов. Нижние — зеленые со светлыми вкраплениями, а верхние – однотонные. Пластины сидячие. С обеих сторон они покрыты ворсинками.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="account-order-product__statuses">
