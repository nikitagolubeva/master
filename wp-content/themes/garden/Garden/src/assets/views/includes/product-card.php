<section class="product-card product discount only-order" data-id="13" data-category="Многолетние цветы">
    <div class="product-card__img-container">
        <a href="#">
            <img class="product-card__img product-img" src="resourses/product.jpg" alt="product image">
        </a>
    ...
    <a href="#" class="product-card__name product-name">МЕДУНИЦА ГИБРИДНАЯ ОПАЛ С3 ВФЫВ ВФ"УВ ВФЫВ ВЫФЫВ ФЫВФЫВФЫВ</a>
    <!-- <a href="#" class="product-card__subgrade">medunica</a> -->
    <a href="#" class="product-card__price-container">
        <div>
            <p class="product-card__price product-price">150 000 ₽</p>
            <p class="product-card__old-price">15 000 ₽</p>
        </div>
        <p class="product-card__discount">-15%</p>
    </a>
    <p class="product-card__status product-status">Предзаказ</p>
    <div class="product-rating" data-rating='1.2'>
    ...
    <p class="hidden product-articul">medunica-opal</p>
    <p class="hidden product-subgrade">medunica</p>
    <p class="hidden product-zone">5</p>
    <p class="hidden product-link">/home</p>
    <ul class="hidden">
    ...
    <ul class="hidden">
        <li class="images">https://swiperjs.com/demos/images/nature-7.jpg</li>
        <li class="images">https://swiperjs.com/demos/images/nature-8.jpg</li>
        <li class="images">https://swiperjs.com/demos/images/nature-2.jpg</li>
        <li class="images">https://swiperjs.com/demos/images/nature-10.jpg</li>
    </ul>
</section>