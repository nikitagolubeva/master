...
?>
    ...
    <div class="wrapper">
        ...
        <main class="account">
            <h1 class="account__header desc">Сменить пароль</h1>
            <h1 class="account__header mobile">сменить пароль</h1>
            <div class="account__container">
                <!-- <ul class="account__nav" data-select="data">
                    ...
                    <a href="/orders" class="account__nav__item" data-select="orders">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/account-password" class="account__nav__item active" data-select="password">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <form class="password-change validate-form">
                        <div class="input-container">
                            <input class="validate-input" type="password" placeholder="Текущий пароль" name="account-old-password" id="account-old-password" data-type="text">
                        </div>
                        <div class="input-container">
                            <input class="validate-input" type="password" placeholder="Новый пароль" name="account-old-password" id="account-new-password" data-type="password">
                        </div>
                        <div class="input-container">
                            <input class="validate-input" type="password" placeholder="Повторить новый пароль" name="account-old-password" id="account-new-repeat-password" data-type="password-repeat">
                        </div>
                        <button class="password-change__btn" type="button">сменить пароль</button>
                        <p class="error-text">
                            Неверный пароль
                        </p>
                        <p class="password-change__alert">
